...
export default function ArtistAuth() {
  ...
  return (
    <div className="mx-auto container-narrow px-4 py-16 max-w-xl">
      <h1 className="text-2xl font-semibold">Become an Artist</h1>
      <p className="text-sm text-gray-600 mt-1">Create your artist profile. This is a stub form.</p>
      <form onSubmit={onSubmit} className="mt-6 card p-6 space-y-4">
        ...
        <div>
          ...
          <select className="w-full rounded-xl border border-gray-300 px-3 py-2" value={discipline} onChange={e=>setDiscipline(e.target.value)}>
            <option>Actor</option>
