...
# Generate Prisma client in the api directory with Lambda binaries
echo ""
...
# Copy runtime directory but exclude WASM files
mkdir -p "${BUILD_DIR}/nodejs/node_modules/@prisma/client/runtime"
rsync -av --exclude='*wasm*' \
  node_modules/@prisma/client/runtime/ \
  "${BUILD_DIR}/nodejs/node_modules/@prisma/client/runtime/" \
  2>/dev/null || cp -r node_modules/@prisma/client/runtime "${BUILD_DIR}/nodejs/node_modules/@prisma/client/"
