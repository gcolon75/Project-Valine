...
const ProductVisualSection = () => {
  return (
    <section className="px-4 py-16 md:py-20 bg-gradient-to-br from-neutral-50 to-white">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                <div className="w-6 h-6 bg-[#0CCE6B]/10 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  <div className="w-2 h-2 bg-[#0CCE6B] rounded-full" />
                </div>
                <div>
                  <h4 className="font-semibold text-neutral-900 mb-1">Professional Portfolio</h4>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-neutral-900 mb-1">Instant Sharing</h4>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <h4 className="font-semibold text-neutral-900 mb-1">Discover Opportunities</h4>
