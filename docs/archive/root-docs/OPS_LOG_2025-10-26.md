...
**Future Option:** Switch to guild endpoint for instant visibility (see [NEXT_STEPS.md](guides/next-steps.md))
...
- [docs/PROJECT_SUMMARY.md](reference/project-summary.md)
- [docs/NEXT_STEPS.md](guides/next-steps.md)
